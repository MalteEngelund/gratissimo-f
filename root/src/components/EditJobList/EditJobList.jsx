    ...
    <div className='flex flex-row justify-between w-full shadow-lg p-4 rounded-2xl border border-border-gray'>
      ...
      <div className='flex flex-col gap-4 justify-between'>
        ...
        <div className='flex flex-row gap-4 justify-between'>
          <button className='bg-dark-red text-text-white px-4 py-2 rounded-2xl cursor-pointer'>Slet</button>
          <button className='bg-light-red px-4 py-2 rounded-2xl cursor-pointer'>Rediger</button>
        </div>
      </div>
    </div>
  )
